...
from verl.single_controller.base import TwoPhaseInitWorker
...
class BaseRollout(TwoPhaseInitWorker, ABC):
    """Base class for rollout.

    This class inherits from TwoPhaseInitWorker to support two-phase initialization
